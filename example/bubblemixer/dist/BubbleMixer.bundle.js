...
},{"./_main.less":5,"./board/Board.js":6,"./controlpanel/ControlPanel.js":15,"eventservice":2,"jquery":4}],2:[function(require,module,exports){
/*global require, module, exports*/
/*jslint node: true */
'use strict';

module.exports = require('./lib/EventService.bundle.min.js');

//-----------------------------------------------------------

},{"./lib/EventService.bundle.min.js":3}],3:[function(require,module,exports){
(function (global){
...
(function() { var head = document.getElementsByTagName('head')[0]; style = document.createElement('style'); style.type = 'text/css';var css = "html,body{position:relative;height:100%;font-family:Arial,sans-serif}html{font-size:80%}body{font-size:1.2rem}.mr-es-radio,.mr-es-range,.mr-es-label{display:inline-block;font-size:1.2rem;vertical-align:middle}";if (style.styleSheet){ style.styleSheet.cssText = css; } else { style.appendChild(document.createTextNode(css)); } head.appendChild(style);}())
...
},{"../uimodule/UiModule.js":29,"./_board.html":7,"./_board.less":8,"./section/Section.js":12,"jquery":4}],7:[function(require,module,exports){
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<section class=\"mr-es-Board\"></section>";
  });

},{"hbsfy/runtime":40}],8:[function(require,module,exports){
(function() { var head = document.getElementsByTagName('head')[0]; style = document.createElement('style'); style.type = 'text/css';var css = ".mr-es-Board{position:relative}";if (style.styleSheet){ style.styleSheet.cssText = css; } else { style.appendChild(document.createTextNode(css)); } head.appendChild(style);}())
...
},{"../../uimodule/UiModule.js":29,"./_bubble.html":10,"./_bubble.less":11,"jquery":4}],10:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<div class=\"mr-es-Bubble\"></div>";
  });

},{"hbsfy/runtime":40}],11:[function(require,module,exports){
(function() { var head = document.getElementsByTagName('head')[0]; style = document.createElement('style'); style.type = 'text/css';var css = ".mr-es-Bubble{position:absolute;width:16px;height:16px;background-color:red;border-radius:100%;transition-timing-function:linear}";if (style.styleSheet){ style.styleSheet.cssText = css; } else { style.appendChild(document.createTextNode(css)); } head.appendChild(style);}())
...
},{"../../uimodule/UiModule.js":29,"../bubble/Bubble.js":9,"./_section.html":13,"./_section.less":14,"jquery":4}],13:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<section class=\"mr-es-Section\">\r\n    <header class=\"mr-es-Section-header\">";
...
(function() { var head = document.getElementsByTagName('head')[0]; style = document.createElement('style'); style.type = 'text/css';var css = ".mr-es-Section{position:relative;display:inline-block;width:250px;height:250px;margin:4px;border:4px dashed #ccc;border-radius:4px}.mr-es-Section-header{padding-left:4px}";if (style.styleSheet){ style.styleSheet.cssText = css; } else { style.appendChild(document.createTextNode(css)); } head.appendChild(style);}())
...
},{"../uimodule/UiModule.js":29,"./_controlPanel.html":16,"./bubblepanel/BubblePanel.js":17,"./sectionpanel/SectionPanel.js":27,"jquery":4}],16:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<section class=\"mr-es-ControlPanel\"></section>";
  });

},{"hbsfy/runtime":40}],17:[function(require,module,exports){
/*global require, module, exports*/
/*jslint node: true */
'use strict';
...
},{"../../uimodule/UiModule.js":29,"./_bubblePanel.html":18,"./_bubblePanel.less":19,"./config/Config.js":20,"./radiolist/RadioList.js":23,"jquery":4}],18:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<form class=\"mr-es-BubblePanel\">\r\n    <div class=\"mr-es-BubblePanel-forms\">\r\n        <div class=\"mr-es-BubblePanel-listHolder\"></div>\r\n        <div class=\"mr-es-BubblePanel-configHolder\"></div>\r\n    </div>\r\n\r\n    <div class=\"mr-es-BubblePanel-actions\">\r\n        <input type=\"button\" value=\"Inflate Bubble\" class=\"mr-es-BubblePanel-addBubbleBtn\"/>\r\n        <input type=\"button\" value=\"Pop Bubble\" class=\"mr-es-BubblePanel-popBubbleBtn\"/>\r\n    </div>\r\n</form>";
  });

},{"hbsfy/runtime":40}],19:[function(require,module,exports){
(function() { var head = document.getElementsByTagName('head')[0]; style = document.createElement('style'); style.type = 'text/css';var css = ".mr-es-BubblePanel{position:relative;margin:10px 0;border:1px #ccc solid;border-radius:4px;background-color:#eee}.mr-es-BubblePanel-forms{margin:10px 0;font-size:0}.mr-es-BubblePanel-listHolder,.mr-es-BubblePanel-configHolder{display:inline-block;vertical-align:top;height:100%;width:calc(50% - 10px);font-size:1.2rem;box-sizing:border-box;margin-right:10px}.mr-es-BubblePanel-listHolder{min-height:30px}.mr-es-BubblePanel-actions{padding:6px 10px}";if (style.styleSheet){ style.styleSheet.cssText = css; } else { style.appendChild(document.createTextNode(css)); } head.appendChild(style);}())
...
},{"../../../uimodule/UiModule.js":29,"./_config.html":21,"./_config.less":22,"jquery":4}],21:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
function program1(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\r\n        <li class=\"mr-es-BubblePanelConfig-colorListItem\">\r\n            <label>\r\n                <input type=\"radio\"\r\n                        class=\"mr-es-radio mr-es-BubblePanelConfig-colorListItemRadio\"\r\n                        name=\"bubbleColor\" value=\""
...
function program2(depth0,data) {
  ...
  buffer += "<div class=\"mr-es-BubblePanelConfig\">\r\n    <label>\r\n        <span class=\"mr-es-label\">Size</span>\r\n        <input type=\"range\" class=\"mr-es-range mr-es-BubblePanelConfig-sizeRange\" min=\"10\" max=\"20\" value=\"10\" step=\"2\"/>\r\n        <span class=\"mr-es-label mr-es-BubblePanelConfig-sizeValue\"></span>\r\n    </label>\r\n    <ul class=\"mr-es-BubblePanelConfig-colorList\">\r\n        ";
...
},{"hbsfy/runtime":40}],22:[function(require,module,exports){
(function() { var head = document.getElementsByTagName('head')[0]; style = document.createElement('style'); style.type = 'text/css';var css = ".mr-es-BubblePanelConfig{padding:4px}.mr-es-BubblePanelConfig-colorList{position:relative;list-style:none;margin:0;padding:0}";if (style.styleSheet){ style.styleSheet.cssText = css; } else { style.appendChild(document.createTextNode(css)); } head.appendChild(style);}())
...
},{"../../../uimodule/UiModule.js":29,"./_radioList.html":24,"./_radioList.less":25,"./_radioListItem.html":26,"jquery":4}],24:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<ul class=\"mr-es-RadioList\"></ul>";
  });

},{"hbsfy/runtime":40}],25:[function(require,module,exports){
(function() { var head = document.getElementsByTagName('head')[0]; style = document.createElement('style'); style.type = 'text/css';var css = ".mr-es-RadioList{position:relative;list-style:none;margin:0;padding:0}.mr-es-RadioListItem{display:inline-block;padding:4px}";if (style.styleSheet){ style.styleSheet.cssText = css; } else { style.appendChild(document.createTextNode(css)); } head.appendChild(style);}())
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<li class=\"mr-es-RadioListItem\" data-id=\""
    ...
    + "\">\r\n    <label>\r\n        <input type=\"radio\" class=\"mr-es-radio mr-es-RadioListItem-radio\" name=\""
...
},{"../../uimodule/UiModule.js":29,"../../utils/stringUtils.js":32,"./_sectionPanel.html":28,"jquery":4}],28:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<form class=\"mr-es-SectionPanel\">\r\n    <label>\r\n        <span>Enter section name:</span>\r\n        <input type=\"text\" class=\"mr-es-SectionPanel-sectionName\"/>\r\n    </label>\r\n    <input type=\"button\" value=\"Add\" class=\"mr-es-SectionPanel-addBtn\"/>\r\n</form>";
  });
...
},{"../utils/extendsFactory.js":31,"./_uiModule.html":30,"eventservice":2,"jquery":4}],30:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
